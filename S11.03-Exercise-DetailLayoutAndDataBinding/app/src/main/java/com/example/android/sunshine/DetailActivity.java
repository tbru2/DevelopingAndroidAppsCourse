...
//      TODO (7) Display the weather icon using mDetailBinding
        ...
        int weatherImagedId = SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(weatherId);
        mDetailBinding.primaryInfo.weatherIcon.setImageResource(weatherImagedId);
        /****************
         * Weather Date *
         ****************/
        /*
