...
import static com.example.android.sunshine.MainActivity.INDEX_WEATHER_MIN_TEMP;
...
//  TODO (18) Create a String array containing the names of the desired data columns from our ContentProvider
    ...
    public static final int INDEX_WEAHTER_MIN_TEMP = 2;
...
//      TODO (13) Find each of the TextViews by ID
        ...
        mLowTemperatureView = (TextView) findViewById(R.id.humidity);
        mHumidityView = (TextView) findViewById(R.id.wind);
...
//          TODO (23) If the loader requested is our detail loader, return the appropriate CursorLoader
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data){
        ...
        String humidityString = SunshineWeatherUtils.formatTemperature(this, humidity);
