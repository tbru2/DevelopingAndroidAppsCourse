...
//  TODO (3) Add a Context field to the constructor and sto
// re that context in mContext
...
//      TODO (7) Generate a weather summary with the date, description, high and low
        ...
        double highInCelesius = mCursor.getDouble(MainActivity.INDEX_WEATHER_MAX_TEMP);
